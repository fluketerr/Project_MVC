...
<body
    ...
    <div
        ...
        <div class="px-8 py-6 flex items-start gap-4 flex-shrink-0">
            ...
            <button
                class="w-9 h-9 bg-white rounded-full flex items-center justify-center text-sm font-semibold text-gray-600 shadow-sm hover:bg-gray-50 transition-colors">
                ?
            </button>

            <div
                class="bg-white/40 text-[10px] text-gray-600 px-4 py-2 rounded-xl max-w-[300px] leading-relaxed border border-white/50">
                ...
                <div class="flex-1 flex justify-between px-8 py-6">
                    ...
                    bg-white/60 rounded-xl px-4 py-4 shadow-inner">
                        ...
                        <form method="POST" action="" class="w-full flex justify-center">
                            ...
                            <button type="submit" name="join" class="w-full bg-green-500 hover:bg-green-600
