    ...
    <div
        ...
        ">
                ...
                <?php if (!isset($_SESSION['user_id'])) { ?>
                    <a class="fixed bottom-5 right-5 w-14 h-14 py-6 z-50 bg-[#DBC3D6]  rounded-full flex items-center justify-center text-4xl font-semibold text-black shadow-sm hover:bg-[#DDAED3] hover:text-white transition-colors"
                        href="/login">
