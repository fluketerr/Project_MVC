...
<aside id="side-menu" class="flex flex-col w-64 h-screen left-0 top-0 xl:bg-transparent xl:bg-none bg-[#F5D0ED]/90 backdrop-blur-sm z-20 absolute xl:static transition-all">
    ...
    <h6  class="justify-center items-center flex mt-2 text-sm mb-1">
        <div class="bg-[#DDAED3]/50 px-1 pt-1 rounded-l-md">โหมด:</div> 
        <div class="bg-[#D9D9D9]/30 px-1 pt-1 rounded-r-md">เข้าร่วมอีเว้น</div>
    </h6>
        ...
        <div id="switch" class="relative flex w-36 p-1 rounded-full bg-[#DDAED3]/50 cursor-pointer select-none">
            ...
            <div class="relative z-10 flex w-full">
                <div class="w-1/2 flex justify-center items-center py-2 text-sm">
                    <svg fill="#DDAED3" width="20" height="20" xmlns="http://www.w3.org/2000/svg" id="Layer_1" viewBox="0 0 24 24" data-name="Layer 1">
                        <path d="m24 9c0-1.654-1.346-3-3-3h-3c-.9 0-1.7.407-2.25 1.037-.55-.63-1.35-1.037-2.25-1.037h-3c-.9 0-1.7.407-2.25 1.037-.55-.63-1.35-1.037-2.25-1.037h-3c-1.654 0-3 1.346-3 3v8h2v7h2v-7h1v7h2v-7h2.5v7h2v-7h1v7h2v-7h2.5v7h2v-7h1v7h2v-7h2zm-17 6h-5v-6c0-.552.449-1 1-1h3c.551 0 1 .448 1 1zm7.5 0h-5v-6c0-.552.449-1 1-1h3c.551 0 1 .448 1 1zm7.5 0h-5v-6c0-.552.449-1 1-1h3c.551 0 1 .448 1 1zm-5-12.5c0-1.381 1.119-2.5 2.5-2.5s2.5 1.119 2.5 2.5-1.119 2.5-2.5 2.5-2.5-1.119-2.5-2.5zm-7.5 0c0-1.381 1.119-2.5 2.5-2.5s2.5 1.119 2.5 2.5-1.119 2.5-2.5 2.5-2.5-1.119-2.5-2.5zm-7.5 0c0-1.381 1.119-2.5 2.5-2.5s2.5 1.119 2.5 2.5-1.119 2.5-2.5 2.5-2.5-1.119-2.5-2.5z" />
                    </svg>
                </div>
                <div class="w-1/2 flex justify-center items-center py-2 text-sm">
                    <svg fill="#213C51" width="20" height="20" xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24">
                        <path d="m4,19c-1.379,0-2.5-1.121-2.5-2.5s1.121-2.5,2.5-2.5,2.5,1.121,2.5,2.5-1.121,2.5-2.5,2.5Zm10.5-2.5c0-1.381-1.119-2.5-2.5-2.5s-2.5,1.119-2.5,2.5,1.119,2.5,2.5,2.5,2.5-1.119,2.5-2.5Zm-2.5-11.5c1.381,0,2.5-1.119,2.5-2.5s-1.119-2.5-2.5-2.5-2.5,1.119-2.5,2.5,1.119,2.5,2.5,2.5Zm5.5,11.5c0,1.381,1.119,2.5,2.5,2.5s2.5-1.119,2.5-2.5-1.119-2.5-2.5-2.5-2.5,1.119-2.5,2.5Zm.336-9.186l5.315-4.556c.419-.359.468-.99.108-1.409-.36-.421-.992-.469-1.41-.108l-5.314,4.555c-.906.776-2.062,1.204-3.254,1.204h-2.561c-1.192,0-2.348-.428-3.254-1.203L2.151,1.241c-.419-.359-1.051-.312-1.41.108-.359.419-.311,1.05.108,1.409l5.315,4.557c.551.472,1.177.833,1.835,1.111v4.073c0,.553.448,1,1,1s1-.447,1-1v-3.564c.24.025.477.064.72.064h2.561c.243,0,.48-.039.72-.064v3.564c0,.553.448,1,1,1s1-.447,1-1v-4.073c.659-.279,1.285-.64,1.836-1.112Zm6.099,15.331c-.6-1.582-2.181-2.646-3.935-2.646s-3.335,1.063-3.935,2.646c-.196.517.064,1.094.581,1.29.516.195,1.094-.064,1.29-.581.307-.811,1.137-1.354,2.065-1.354s1.758.544,2.065,1.354c.151.399.532.646.935.646.118,0,.238-.021.354-.064.516-.196.776-.773.581-1.29Zm-11.935-2.646c-1.754,0-3.335,1.063-3.935,2.646-.196.517.064,1.094.581,1.29.515.195,1.094-.064,1.29-.581.307-.811,1.137-1.354,2.065-1.354s1.758.544,2.065,1.354c.151.399.532.646.935.646.118,0,.238-.021.354-.064.516-.196.776-.773.581-1.29-.6-1.582-2.181-2.646-3.935-2.646Zm-8,0c-1.754,0-3.335,1.063-3.935,2.646-.196.517.064,1.094.581,1.29.516.195,1.094-.064,1.29-.581.307-.811,1.137-1.354,2.065-1.354s1.758.544,2.065,1.354c.151.399.532.646.935.646.118,0,.238-.021.354-.064.516-.196.776-.773.581-1.29-.6-1.582-2.181-2.646-3.935-2.646Z" />
                    </svg>
                </div>
            </div>
        </div>
            ...
            <?php if (isset($_SESSION['user_email'])) { ?>
                ...
                <div name="bottom_menu" class="flex items-center gap-3">
                    ...
                    <div class="flex flex-col">
                        ...
                        <span class="text-sm text-slate-500">UID:
                            <?= isset($_SESSION['user_id']) ? $_SESSION['user_id'] : 'Update User' ?>
                        </span>
