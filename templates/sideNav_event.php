...
<aside class="flex flex-col w-64 bg-transparent h-screen left-0 top-0">
    ...
    <nav class="flex flex-col h-full">
        <ul name="top_main_menu" class="list-none p-0 m-0">
            <li class="m-0">
                <a href="/events" class="flex items-center px-5 py-4 text-[#1E293B] no-underline transition-all duration-300 border-l-4 border-transparent hover:bg-[#6594B1] hover:border-l-[#213C51]">
            ...
            <li class="m-0">
                <a href="/update_event" class="flex items-center px-5 py-4 text-[#1E293B] no-underline transition-all duration-300 border-l-4 border-transparent hover:bg-[#6594B1] hover:border-l-[#213C51]">
        ...
        <ul name="bottom_menu" class="list-none p-0 m-0 mt-auto">
            <?php if (isset($_SESSION['user_email'])) { ?>
                <li class="m-0">
                    <a href="/update_user" class="gap-2 flex items-center px-5 py-2 text-[#1E293B] no-underline transition-all duration-300 border-l-4 border-transparent hover:bg-[#6594B1] hover:border-l-[#213C51]">
                ...
                <li class="m-0">
                    <a class="gap-2 flex items-center px-5 py-2 text-[#1E293B] no-underline transition-all duration-300 border-l-4 border-transparent hover:bg-[#6594B1] hover:border-l-[#213C51]">
                        <span class="text-base">UID:</span>
                        <span class="text-base"><?= isset($_SESSION['user_id']) ? $_SESSION['user_id'] : 'Update User' ?></span>
                    </a>
                </li>
                <li class="m-0">
                    <a href="/logout" class="flex items-center px-5 py-2 text-[#1E293B] no-underline transition-all duration-300 border-l-4 border-transparent hover:bg-[#6594B1] hover:border-l-[#213C51]">
            ...
            <?php } else { ?>
                <li class="m-0">
                    <a href="/login" class="flex items-center px-5 py-4 text-[#1E293B] no-underline transition-all duration-300 border-l-4 border-transparent hover:bg-[#6594B1] hover:border-l-[#213C51]">
