...
<aside class="flex flex-col w-64 bg-transparent h-screen left-0 top-0">
    ...
    <div class="w-full grid grid-cols-[1fr_1fr_1fr_1fr_1fr] items-center gap-4 px-5 pt-6">
        <a class="w-7 h-7 bg-[#6594B1]  rounded-full flex items-center justify-center text-sm font-semibold text-black shadow-sm hover:bg-[#213C51] hover:text-white transition-colors"
            href="/events">
            <svg fill="white" width="10" height="10" xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="512" height="512"><path d="M.88,14.09,4.75,18a1,1,0,0,0,1.42,0h0a1,1,0,0,0,0-1.42L2.61,13H23a1,1,0,0,0,1-1h0a1,1,0,0,0-1-1H2.55L6.17,7.38A1,1,0,0,0,6.17,6h0A1,1,0,0,0,4.75,6L.88,9.85A3,3,0,0,0,.88,14.09Z"/></svg>
        </a>
        <a href="/" class="">
